...
![*Individual shrubs detected from direct point cloud segmentation*](Figures\\IndivdualShrub_PCSeg.png)
...
*Execute code below to create a 3D window and scroll around with mouse*
