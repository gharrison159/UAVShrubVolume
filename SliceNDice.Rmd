...
las <- readLAScatalog("C:\\Users\\shre9292\\OneDrive - University of Idaho\\Documents\\GitHub\\UAVShrubVolume\\DATA\\PointCloud_compressed\\PointCloud_Compressed.las")
...
poly <- Polygon(list2$ARAR_1_sdf)
sf <- st_as_sf(list2$ARAR_1_sdf)
```
