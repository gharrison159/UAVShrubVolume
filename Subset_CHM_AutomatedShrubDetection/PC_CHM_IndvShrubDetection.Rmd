...
# NOTE: usually, trees are taller than they are wide. Hence default max crown diamter is set to 0.6, no larger than 60% of the total height of the tree. HOWEVER, shrubs are wider than they are tall (field data shows avg height = 56.8 cm vs avg width = 88.4 cm) 
...
# converting cell values of raster into 1 (delineated shrub) and 0 (non-shrub) exporting individual shrub delineation rasters
...
writeRaster(crowns_silva_lmf, 'C:\\Users\\shre9292\\OneDrive - University of Idaho\\Documents\\GitHub\\UAVShrubVolume\\Subset_CHM_AutomatedShrubDetection\\Outputs\\IndividualDetectedShrubs\\IndvShrubs_Silva_LMF.tif')

writeRaster(crowns_silva_vwf, 'C:\\Users\\shre9292\\OneDrive - University of Idaho\\Documents\\GitHub\\UAVShrubVolume\\Subset_CHM_AutomatedShrubDetection\\Outputs\\IndividualDetectedShrubs\\IndvShrubs_Silva_VWF.tif')


test_raster <- crowns_silva_lmf

test_raster[!is.na(test_raster[])] <- 1
test_raster[is.na(test_raster[])] <- 0

test_raster@data@values
