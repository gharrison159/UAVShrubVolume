...
shrub_poly <- sfheaders::sf_polygon(
  ...
  x = "Longitude", y = "Latitude",
  polygon_id = "Shrub_ID")
st_crs(shrub_polygon) <- 6340 #set to NAD83 Z11 (same as Shapefile or other Vector format used)
...
```{r}
writeOGR(obj=shrubs_spdf, dsn="shapefile_exports", layer="shrubs", driver="ESRI Shapefile") # this is in geographical projection
